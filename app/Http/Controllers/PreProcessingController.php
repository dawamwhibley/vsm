...
class PreProcessingController extends Controller
{
    ...
    {
        $query_case     = self::case_folding($query);
        $query_token    = self::tokenizing($query_case);
        $query_filter   = self::filtering($query_token);
        $query_dasar    = self::stemming($query_filter);
        return $query_dasar;
    }
    ...
    {
        $kelas = new PreProcessingController();
